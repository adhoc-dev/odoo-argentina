...
class CrmLead(models.Model):
    ...
    x_studio_n_documento_padre = fields.Integer(string="N° Documento", copy=False)
    ...
    x_mother_country_id = fields.Many2one(string="Nacionalidad", comodel_name="res.country", on_delete="set null")
    x_father_country_id = fields.Many2one(string="Nacionalidad", comodel_name="res.country", on_delete="set null")
    x_studio_n_documento_madre = fields.Integer(string="N° Documento")
    x_student_birthdate = fields.Date(string="Fecha de Nacimiento")
    x_mother_birthdate = fields.Date(string="Fecha de Nacimiento")
    x_father_birthdate = fields.Date(string="Fecha de Nacimiento")
    x_father_profession = fields.Char(string="Profesión/Ocupación")
    x_mother_profession = fields.Char(string="Profesión/Ocupación")
    x_father_act_condition = fields.Selection(string="Condición de la Actividad", selection=[('tp','Trabajo Permanente'),('tt','Trabajo Temporario'),('am','Ama de Casa'),('jp','Jubilado/Pensionado'),('d','Discapacitado'),('o','Otros')])
    x_mother_act_condition = fields.Selection(string="Condición de la Actividad", selection=[('tp','Trabajo Permanente'),('tt','Trabajo Temporario'),('am','Ama de Casa'),('jp','Jubilado/Pensionado'),('d','Discapacitado'),('o','Otros')])
    x_father_phone = fields.Char(string="Teléfono")
    x_mother_phone = fields.Char(string="Teléfono")
    x_father_first_name = fields.Char(string="Nombre")
    x_mother_first_name = fields.Char(string="Nombre")
    x_father_last_name = fields.Char(string="Apellido")
    x_mother_last_name = fields.Char(string="Apellido")
    ...
    x_mother_nosis = fields.Char(string="Nosis")
    x_father_nosis = fields.Char(string="Nosis")
    x_mother_approve = fields.Selection(string="Aprueba excepción", selection=[('si', 'Si'),('no','No')])
    x_father_approve = fields.Selection(string="Aprueba excepción", selection=[('si', 'Si'),('no','No')])
