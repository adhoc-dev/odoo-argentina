...
class ProductPackLine(models.Model):
    ...
    x_product_template_standard_price = fields.Float(string="Costo contable", related="product_id.standard_price", help="Cost used for stock valuation in standard price and as a first price to set in average/fifo. Also used as a base price for pricelists. Expressed in the default unit of measure of the product. ", readonly=True, copy=False)
