...
from . import legal_auxiliary
from . import legal_auxiliary_field
from . import legal_department
from . import legal_claim
...
from . import legal_negotiation
from . import legal_negotiation_concept
from . import legal_news
from . import legal_news_type
from . import legal_offerer
from . import legal_office
from . import legal_type_prosecution
from . import legal_expertise_detail
from . import legal_expertise_type
from . import legal_evidence_type
from . import legal_expertise_detail_type
