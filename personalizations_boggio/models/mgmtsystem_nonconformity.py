...
class MgmtsystemNonconformity(models.Model):
    ...
    x_origen_no_conformidad = fields.Many2one(string="¿Dónde ocurrió el desvío?", comodel_name="x_origen_tags", help="Sector en el cual se produjo el error.", on_delete="set null", required=True)
